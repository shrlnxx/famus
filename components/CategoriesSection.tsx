...
const categories: Category[] = [
  ...
  },
  {
    ...
    title: "Pidato Putra",
    level: "6-13 Tahun",
    desc: "Menyampaikan pidato tema islami dengan durasi 4-5 menit, wajib menyertakan dalil Al-Qur'an/Hadis.Berikut Plihan Tema nya : 1). Berbakti Kepada Orang Tua, 2). Menyayangi Sesama,3). Semangat Meraih Cita-Cita, 4). Pentingnya Menuntut Ilmu, 5). Menjaga Lingkungan.",
    fee: 35000,
    kuota: "25 Putra",
